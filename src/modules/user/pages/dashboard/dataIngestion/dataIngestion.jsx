...
const DashboardDataIngestionPage = () => {
  ...
  return (
    <div className="pb-20">
      <div className="bg-white shadow-lg md:py-10 py-6 md:px-6 px-4 w-full border-[1px] border-primaryColor rounded-xl">
        <h1 className="text-black font-semibold md:text-3xl sm:text-2xl text-lg">
          Upload Educational Data
        </h1>
...
export default DashboardDataIngestionPage;
