...
const TeacherUpdateStudentPage = () => {
    const {id} = useParams();
    ...
    const { getSingleStudent, singleStudent ,updateStudent, loading } = useContext(StudentContext);
...
export default TeacherUpdateStudentPage;