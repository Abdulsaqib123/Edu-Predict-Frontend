                ...
                <form onSubmit={handleFormSubmit} method="POST">
                    <div className="sm:space-y-8 space-y-4">
                        <div className="form-group">
                            ...
                            <select name="role" id="role" className="w-full border-[1px] border-white rounded-md placeholder:text-primaryColor text-black bg-white shadow-md text-sm py-3 px-4 focus:border-primaryColor outline-none" onChange={handleInputChange}>
